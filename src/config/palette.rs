...
/// Preview reading line — stronger than the cursorline wash so the synced
/// panel's "look here" marker reads at a glance across the split.
pub const PREVIEW_READING_BG: Color = Color::Rgb(0x33, 0x44, 0x4E);
